...
@Component({
  selector: 'app-mi-perro-dashboard',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule,
  ...
  templateUrl: './mi-perro-dashboard.component.html',
  styleUrl: './mi-perro-dashboard.component.css'
})
export class MiPerroDashboardComponent implements OnInit {
  mascotas: Mascota[] = [];
  totalMascotas = 0;
  totalHistorial = 0;
