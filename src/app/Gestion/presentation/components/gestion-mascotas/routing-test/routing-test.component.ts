  ...
  template: `
    <div class="routing-test-container">
      <mat-card class="test-card">
        <mat-card-header>
          <mat-card-title class="heading-3">🧪 Test de Routing - Gestión de Mascotas</mat-card-title>
        </mat-card-header>
        <mat-card-content>
          <div class="test-info">
          ...
          <div class="test-actions">
            ...
            <div class="button-group">
              <button class="btn-primary" routerLink="/gestion-mascotas">
                <mat-icon>dashboard</mat-icon>
                Dashboard
              </button>
              <button class="btn-primary" routerLink="/gestion-mascotas/mascotas">
                <mat-icon>pets</mat-icon>
                Lista Mascotas
              </button>
              <button class="btn-primary" routerLink="/gestion-mascotas/mascotas/nueva">
                <mat-icon>add</mat-icon>
                Nueva Mascota
              </button>
              <button class="btn-primary" routerLink="/gestion-mascotas/mascotas/1">
                <mat-icon>visibility</mat-icon>
                Detalle Mascota (ID: 1)
              </button>
              <button class="btn-primary" routerLink="/gestion-mascotas/mascotas/1/editar">
